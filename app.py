...
def detail(plant_id):
    ...
    plant_to_show = mongo.db.plants.find_one({'id':plant_id})
...
def harvest(plant_id):
    ...
    inserted_harvest = mongo.db.plants.insert_one(new_harvest).inserted_harvest

    return redirect(url_for('detail', plant_id=inserted_harvest))
